...
module.exports = function( grunt ) {
    ...
    grunt.initConfig({
        ...
        meta: {
            banner: "/*! Dongle v<%= pkg.version %> https://github.com/webbers/dongle.js | https://github.com/webbers/dongle.js/blob/master/MIT-LICENSE.txt */"
        },
        compare_size: {
            files: distpaths
        },
        ...
        /*qunit: {
            files: "src/Dongle.Js/Test/index.html"
        },*/
        ...
        server: {
            port: 8000,
            base: 'P:/github/dongle.js'
        },
        
        watch: {
            files: [
                "<config:lint.grunt>", "<config:lint.tests>",
                "src/Dongle.Js/Src/**/*.js"
            ],
            tasks: "dev"
        },
        uglify: {}
    ...
    // Default grunt.
    //grunt.registerTask( "default", /*"submodules selector */"build:*:* lint min"); // lint min dist:* compare_size" );
    ...
    grunt.registerTask( "testswarm", function( commit, configFile ) {
        ...
        testswarm({
            ...
            jobName: 'Dongle commit #<a href="https://github.com/webbers/dongle/commit/' + commit + '">' + commit.substr( 0, 10 ) + '</a>',
