...
(function($){
    ...
    test("init", function(){
        ...
        start();
        el = $("select").wselect(), $header = header();
    ...
    test("form submission", function(){
        ...
        el.wselect("checkAll").wselect("destroy");
        data = form.serialize();
    ...
    test("form submission, optgroups", function(){
        ...
        el.wselect("widget").find('.wselect-checkboxes li:not(.wselect-optgroup-label) input:even').each(function( i ){
            this.click();
        });
    ...
    test("form submission, single select", function(){
        ...
        el.wselect("checkAll");
        data = form.serialize();
        equal( el.wselect("getChecked").length, 1, 'After checkAll, only one radio is selected');
    ...
    asyncTest("form reset, nothing pre-selected", function(){
        ...
        el = $('<select name="test" multiple="multiple"><option value="foo">foo</option><option value="bar">bar</option></select>')
            .appendTo(form)
            .wselect({ noneSelectedText: noneSelected })
            .wselect("checkAll");
    ...
    asyncTest("form reset, pre-selected options", function(){
        ...
        el = $('<select name="test" multiple="multiple"><option value="foo" selected="selected">foo</option><option value="bar" selected="selected">bar</option></select>')
            .appendTo(form)
            .wselect({ selectedText: '# of # selected' })
            .wselect("uncheckAll");
