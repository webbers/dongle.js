...
jQuery.event = {
	...
	props: "altKey attrChange attrName bubbles button cancelable charCode clientX clientY ctrlKey currentTarget data detail eventPhase fromElement handler keyCode layerX layerY metaKey newListValue offsetX offsetY pageX pageY prevListValue relatedNode relatedTarget screenX screenY shiftKey srcElement target toElement view wheelDelta which".split(" "),
...
jQuery.Event.prototype = {
	preventDefault: function() {
		...
		// otherwise set the returnListValue property of the original event to false (IE)
		} else {
			e.returnValue = false;
		}
	},
